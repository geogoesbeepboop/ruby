...
struct StreamingCoordinator: View {
    ...
    var body: some View {
        Group {
            // Display appropriate streaming view based on active workflow
            if chatCoordinator.uiManager.currentState == .streaming {
                streamingContent
            } else if chatCoordinator.uiManager.currentState == .aiThinking {
...
struct DefaultStreamingResponseView: View {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                HStack {
                    Circle()
                        ...
                        .scaleEffect(streamingScale)
                        .animation(
                            .easeInOut(duration: 0.6).repeatForever(autoreverses: true),
                            value: streamingScale
                        )
    ...
    @State private var streamingScale: CGFloat = 1.0
}
